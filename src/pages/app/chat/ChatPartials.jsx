...
export const MeChat = ({ item, chat, onRemoveMessage, messageId, isDelivered, isRead }) => {
    ...
    <div className="chat is-me">
      <div className="chat-content">
                              ...
                              <ul className="link-list-opt no-bdr">
                                <li>
                                  <DropdownItem
                                    ...
                                    onClick={(ev) => {
                                      ev.preventDefault();
                                      direct.startEditing({ id: messageId, content: msg });
                                    }}
                                  >
                                    Edit
                                  </DropdownItem>
        ...
        <ul className="chat-meta">
          ...
          <li>
            {isRead ? (
              <Icon name="check-circle-fill" className="text-success"></Icon>
            ) : isDelivered ? (
...
export const YouChat = ({ item, chat, messageId }) => {
  const direct = useContext(DirectChatContext);
  const [menuOpen, setMenuOpen] = useState(false);
  return (
