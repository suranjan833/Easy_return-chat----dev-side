  ...
  return (
    <form className="content clearfix" onSubmit={handleSubmit(submitForm)}>
      <Row className="gy-4">
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-first-name">
              First Name
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-last-name">
              Last Name
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-email">
              Email Address
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-phone-no">
              Mobile Number
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-city">
              City
            </label>
            <div className="form-control-wrap">
              <input
  ...
  return (
    <form className="content clearfix" onSubmit={handleSubmit(submitForm)}>
      <Row className="gy-4">
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-username">
              Username
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-password">
              Password
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-rePassword">
              Re-Password
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Col md="12">
          <div className="custom-control custom-checkbox">
            <input
              ...
              id="vr-fw-policy" />
            {errors.terms && <span className="invalid">This field is required</span>}
            <label className="custom-control-label" htmlFor="vr-fw-policy">
              I agreed Terms and policy
            </label>
          </div>
        </Col>
  ...
  return (
    <form className="content clearfix" onSubmit={handleSubmit(submitForm)}>
      <Row className="gy-3">
        <Col md="12">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-fw-token-address">
              Token Address
            </label>
            <div className="form-control-wrap">
              <input
            ...
            <li>
              <div className="custom-control custom-radio">
                <input
                  ...
                  onChange={() => setFormData({ ...formData, contribute: "leEth" })} />
                {errors.ethRadio && <span className="invalid">This field is required</span>}
                <label className="custom-control-label" htmlFor="vr-fw-lt1eth">
                  Less than 1 ETH
                </label>
              </div>
            </li>
            <li>
              <div className="custom-control custom-radio">
                <input
                  ...
                  checked={formData.contribute === "ovEth" ? true : false}
                  onChange={() => setFormData({ ...formData, contribute: "ovEth" })} />
                <label className="custom-control-label" htmlFor="vr-fw-ov1eth">
                  Over than 1 ETH
                </label>
              </div>
            </li>
        ...
        <Col md="6">
          <div className="form-group">
            <label className="form-label" htmlFor="vr-fw-telegram-username">
              Telegram Username
            </label>
            <div className="form-control-wrap">
              <input
        ...
        <Block size="lg">
          ...
          <PreviewCard>
            <div className="nk-wizard nk-wizard-simple is-vertical is-alter wizard clearfix">
              <Steps config={config}>
                <Step component={PersonalFormVR} />
                <Step component={UserSettingsVR} />
                <Step component={PaymentInfoVR} />
                <Step component={SuccessVR} />
              </Steps>
            </div>
          </PreviewCard>
        </Block>
