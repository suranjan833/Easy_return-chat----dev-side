...
const MessageInfoModal = ({ isOpen, message, onClose, groupMembers }) => {
  ...
  const readAt =
    message.read_at || updatedAtFallback || firstReceipt?.read_at || null;
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            <div
              style={{ fontWeight: 600, fontSize: "14px", color: "#1a1a2e" }}
            >
              {fullName}
            </div>
            {sender.email && (
        ...
        <div
          style={{
            ...
            gap: "10px",
            marginBottom: isGroupMessage ? "20px" : "0",
          }}
        >
          {sentAt && (
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <i
                ...
                style={{ color: "#6576ff", fontSize: "14px", width: "16px" }}
              />
              <div>
                <div
                  style={{
          ...
          {!isGroupMessage && (
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <i
                className={`bi ${readAt ? "bi-check2-all" : "bi-check2"}`}
                style={{
                  color: readAt ? "#1ee0ac" : "#aaa",
                  fontSize: "16px",
                  width: "16px",
                }}
              />
              <div>
                ...
                >
                  {readAt
                    ? format(
                        new Date(
                          readAt.length === 16 ? `${readAt}:00` : readAt,
                        ),
                        "dd MMM, hh:mm a",
                      )
                    : "Not yet read"}
          ...
          {editedAt && (
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <i
                ...
                style={{ color: "#f4bd0e", fontSize: "13px", width: "16px" }}
              />
              <div>
                <div
                  style={{
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              >
                <i
                  ...
                  style={{ color: "#1ee0ac", fontSize: "15px" }}
                />
                <span
