...
import NotificationPage from "../layout/header/dropdown/notification/NotificationPage";
// import ViewAll from "../layout/header/dropdown/notification/ViewAll";
...
import ChatPopupsPage from "@/pages/app/chat-popups/ChatPopupsPage";
...
import GroupChat from "@/pages/app/group-chat/GroupChatContainer";
...
import UpadeteUser from "../pages/User/UpdateUser";
import ViewUser from "../pages/User/ViewUser";

import AgentsByDepartment from "../pages/Agent/AgentsByDepartment";
...
import UpdatDepartment from "../pages/Department/UpdateDepartment";
import ViewDepartment from "../pages/Department/ViewDepartment";

import MultiChatManager from "../pages/app/chat/MultiChatManager";
...
import ViewRole from "../pages/UserRole/ViewRole";
...
// import UsersBySite from '../pages/User/UsersBySite'
// import AgentsBySite from "../pages/User/AgentsBySite";
// import ManagersBySite from "../pages/User/ManagersBySite";
// import RecentChats from "../pages/Messages/RecentlyChat";
// import ChatPageApp from '../pages/messaging/ChatPageApp'
// import ChatMessages from "../pages/Messaging/ChatMessages";
import AgentChatsPage from "../pages/agentschat/AgentChatsPage";
// All Sites Route Here
import AgentsBySite from "../pages/Sites/AgentsBySite";
import CreateSite from "../pages/Sites/CreateSite";
import EditSite from "../pages/Sites/EditSite";
import ManagersBySite from "../pages/Sites/ManagersBySite";
import SiteList from "../pages/Sites/SiteList";
import UsersBySite from "../pages/Sites/UsersBySite";
import VerifySite from "../pages/Sites/VerifySite";
import ViewSite from "../pages/Sites/ViewSite";
// All Group Pages Route Here
// import GroupListPage from "../pages/Groups/GroupsPage";
import CreateGroupPage from "../pages/app/group-chat/GroupCreate";
import GroupSettingsPage from "../pages/app/group-chat/GroupSetting";
import AddMembersPage from "../pages/Groups/AddMembersPage";
import GroupFilesPage from "../pages/Groups/GroupFilesPage";
import GroupMessagesPage from "../pages/Groups/GroupMessagesPage";
import MembersPage from "../pages/Groups/MembersPage";
import RemoveMembersPage from "../pages/Groups/RemoveMembersPage";
import UsersNotInGroupPage from "../pages/Groups/UsersNotInGroupPage";
import AgentDashboard from "../pages/Support/AgentDashboard";
import ShortcutsPage from "../pages/Support/ShortcutsPage";
import SupportChatWidget from "../pages/Support/SupportChatWidget";
...
const Router = () => {
  return (
    ...
    >
      <ScrollToTop>
        {/* Service worker navigation hook inside router context */}
        <SwNavigateListener />
        <Routes>
          <Route element={<ThemeProvider />}>
            <Route element={<Layout />}>
              ...
              <Route path="/users/:id/edit" element={<UpadeteUser />}></Route>
              <Route
                path="/search-users"
                element={
                  <ProtectedRoute allowedRoles={[2]}>
              ...
              ></Route>
              {/*
              <Route path="/users-by-site" element={<UsersBySite />}></Route>
              <Route path="/agents-by-site" element={<AgentsBySite />}></Route>
              <Route path="/managers-by-site" element={<ManagersBySite />}></Route> */}

              {/* My All User Roles Routes */}

              <Route path="/roles/create" element={<CreateRole />}></Route>
              <Route path="/list-roles" element={<RoleList />}></Route>
              <Route path="/roles/:roleId" element={<ViewRole />} />
              <Route path="/roles/list" element={<RoleList />}></Route>
              <Route path="/edit-role/:roleId" element={<EditRole />}></Route>

              {/*  My All Department Routes */}
              {/* My All Department Routes */}
              <Route
              ...
              <Route
                ...
                element={<UpdatDepartment />}
              ></Route>
              <Route
                path="departments/:departmentId/stats"
                element={<DepartmentStatistics />}
              ></Route>
              <Route
                path="agents-by-department"
                element={<AgentsByDepartment />}
              ></Route>
              <Route
              ...
              {/* My All Mesaage Routes  */}
              {/* <Route path="/messages/:user_id_1/:user_id_2" element={<ChatMessages />}></Route> */}
              {/* <Route path="/messages/:userId/:recipientId" element={<ChatPageApp />}></Route> */}

              {/* <Route path="/recent-chats" element={<RecentChats />}></Route> */}
              ...
              />
              <Route path="/sites/verify" element={<VerifySite />}></Route>
              <Route
                path="/site/:site_id/users"
                element={<UsersBySite />}
              ></Route>
              <Route path="/edit-site/:siteId" element={<EditSite />}></Route>
              <Route path="/sites/:siteId" element={<ViewSite />} />
              <Route
                path="/site/:site_id/agents"
                element={<AgentsBySite />}
              ></Route>
              <Route
                path="/site/:site_id/managers"
                element={<ManagersBySite />}
              ></Route>

              {/* <Route path="/groups" element={<GroupListPage />} /> */}
              <Route path="/app-group-create" element={<CreateGroupPage />} />
              <Route
              ...
              />
              <Route
                path="/groups/:groupId/users-not-in-group"
                element={<UsersNotInGroupPage />}
              />
              <Route
              ...
              />
              <Route
                path="/app-group-create/:groupId/settings"
                element={<GroupSettingsPage />}
              />
              <Route path="/agent-chats" element={<AgentChatsPage />} />

              <Route
                path="/support-chat/:ticketNumber?"
                element={<SupportChatWidget />}
              />
              <Route
                path="/agent-dashboard"
                element={<AgentDashboard agentEmail="test@example.com" />}
              />
              <Route
                path="/shortcuts"
                element={
              ...
              <Route path="multi-chat" element={<MultiChatManager />}></Route>
              <Route path="app-messages" element={<AppMessages />}></Route>
              <Route path="messages" element={<Chat />}></Route>
              <Route path="app-group-chat" element={<GroupChat />}></Route>
              <Route path="chat-popups" element={<ChatPopupsPage />}></Route>
...
// Listens for SW messages and navigates using React Router context
function SwNavigateListener() {
  const location = useLocation();
  const navigate = React.useCallback((to, opts) => {
    // Lazy import useNavigate-like behavior using window.history while inside Router
    if (opts?.replace) {
      window.history.replaceState({}, "", to);
      // Trigger a manual navigation via dispatchEvent so Router responds
  ...
  useEffect(() => {
    ...
    const handler = (event) => {
      ...
      if (
        (data.type === "notificationclick" || data.action === "navigate") &&
