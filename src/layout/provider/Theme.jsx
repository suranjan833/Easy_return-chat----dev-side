...
const ThemeProvider = ({...props}) => {
  ...
  const defaultTheme = {
    ...
    const themeUpdate = {
      ...
      sidebarHidden : function(e){
        setTheme({...theme, sidebarHidden : !theme.sidebarHidden, sidebarVisibility : false})
      },
  ...
  useEffect(() => {
    const handleMobileSidebar = () => {
        if (window.innerWidth < 1200) {
          setTheme({...theme, sidebarMobile : true, sidebarHidden : false, sidebarVisibility : false})
        } else {
